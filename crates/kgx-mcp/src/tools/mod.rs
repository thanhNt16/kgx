...
pub fn tool_schemas() -> Value {
    serde_json::json!([
        ...
        {"name":"query_memory","description":"Structured query with filters: type, tag, project, date, status","inputSchema":{"type":"object","properties":{"note_type":{"type":"string"},"tag":{"type":"string"},"project":{"type":"string"},"status":{"type":"string"},"limit":{"type":"integer"}}}},
